...
set packages \
    ...
    hypridle hyprland hyprlock hyprpaper hyprpolkitagent inetutils \
    ...
    python-pipx qt5-wayland qt6-wayland ripgrep rsync slurp socat tlp \
    ttf-dejavu ttf-liberation ufw unzip upower vulkan-intel waybar-git \
    webapp-manager wget wireplumber wl-clipboard xdg-desktop-portal-gtk \
    xdg-desktop-portal-hyprland xdg-utils xwayland-satellite
